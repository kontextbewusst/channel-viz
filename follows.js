(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'Zv6MZHKinHkLBWvi2dRQkDXVSlGKE5SodOXNLb0VeG09rpCz', // Unique master Xively API key to be used as a default
		defaultFeeds	= [428155474], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'RasPi Weather Channel', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
